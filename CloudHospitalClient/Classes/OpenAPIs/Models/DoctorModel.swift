...
public struct DoctorModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, userName: String? = nil, firstName: String? = nil, lastName: String? = nil, fullName: String? = nil, userType: String? = nil, photo: String? = nil, photoThumbnail: String? = nil, timeZone: String? = nil, auditableEntity: AuditableEntity? = nil, phone: String? = nil, email: String? = nil, gender: Gender? = nil, dateOfBirth: Date? = nil, communicationUserId: String? = nil, languages: [UserLanguageModel]? = nil, locations: [UserLocationModel]? = nil, startPracticeDate: Date? = nil) {
        self.id = id
