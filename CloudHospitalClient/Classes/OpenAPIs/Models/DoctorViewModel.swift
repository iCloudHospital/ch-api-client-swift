...
public struct DoctorViewModel: Codable {
    ...
    public init(slug: String? = nil, startPracticeDate: Date? = nil, yearOfExperience: Double? = nil, overview: String? = nil, consultationEnabled: Bool? = nil, consultationFee: Double? = nil, doctorReviews: [DoctorReviewItemViewModel]? = nil, doctorEducations: [DoctorEducationItemViewModel]? = nil, doctorPortfolios: [DoctorPortfolioItemViewModel]? = nil, doctorSpecialties: [DoctorSpecialtyItemViewModel]? = nil, doctorCertificates: [DoctorCertificateItemViewModel]? = nil, doctorAffiliations: [HospitalAffiliationViewModel]? = nil, articles: [Article]? = nil, awards: [AwardViewModel]? = nil, medias: [MediaViewModel]? = nil, userType: String? = nil, languages: [UserLanguageViewModel]? = nil, locations: [UserLocationViewModel]? = nil, id: UUID? = nil, userName: String? = nil, firstName: String? = nil, lastName: String? = nil, fullname: String? = nil, phone: String? = nil, email: String? = nil, photo: String? = nil, photoThumbnail: String? = nil, gender: Gender? = nil, dateOfBirth: Date? = nil, timeZone: String? = nil, communicationUserId: String? = nil, auditableEntity: AuditableEntity? = nil) {
        self.slug = slug
