...
public struct DoctorItemViewModel: Codable {
    ...
    public init(slug: String? = nil, consultationEnabled: Bool? = nil, consultationFee: Double? = nil, overview: String? = nil, doctorReviewsCount: Int? = nil, doctorEducationsCount: Int? = nil, doctorPortfoliosCount: Int? = nil, doctorSpecialtiesCount: Int? = nil, doctorSpecialties: [DoctorSpecialtyItemViewModel]? = nil, doctorCertificatesCount: Int? = nil, doctorAffiliationsCount: Int? = nil, doctorAffiliations: [HospitalAffiliationViewModel]? = nil, articlesCount: Int? = nil, id: UUID? = nil, userName: String? = nil, firstName: String? = nil, lastName: String? = nil, fullname: String? = nil, phone: String? = nil, email: String? = nil, photo: String? = nil, photoThumbnail: String? = nil, gender: Gender? = nil, dateOfBirth: Date? = nil, timeZone: String? = nil, communicationUserId: String? = nil, auditableEntity: AuditableEntity? = nil) {
        self.slug = slug
