...
public struct FaqCategoryItemModel: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, languageCode: String? = nil, name: String? = nil, slug: String? = nil, confirmed: Bool? = nil, parentId: UUID? = nil, order: Int? = nil, hospitalId: UUID? = nil, hospitalName: String? = nil, hospitalSlug: String? = nil, hospitalWebsiteUrl: String? = nil, medias: [MediaModel]? = nil, auditableEntity: AuditableEntity? = nil) {
        self.id = id
