...
open class QuestionsAPI {
    ...
    open class func apiV1HospitalsHospitalIdQuestionsPost(hospitalId: UUID, createQuestionCommand: CreateQuestionCommand? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<UUID, Error> {
    ...
    open class func apiV1HospitalsHospitalIdQuestionsPostWithRequestBuilder(hospitalId: UUID, createQuestionCommand: CreateQuestionCommand? = nil) -> RequestBuilder<UUID> {
        var localVariablePath = "/api/v1/hospitals/{hospitalId}/questions"
        ...
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: createQuestionCommand)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1HospitalsHospitalIdQuestionsQuestionIdDelete(hospitalId: UUID, questionId: UUID, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<Bool, Error> {
    ...
    open class func apiV1HospitalsHospitalIdQuestionsQuestionIdDeleteWithRequestBuilder(hospitalId: UUID, questionId: UUID) -> RequestBuilder<Bool> {
        var localVariablePath = "/api/v1/hospitals/{hospitalId}/questions/{questionId}"
        let hospitalIdPreEscape = "\(APIHelper.mapValueToPathItem(hospitalId))"
        let hospitalIdPostEscape = hospitalIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{hospitalId}", with: hospitalIdPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter questionId: (path)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - returns: AnyPublisher<QuestionViewModel, Error>
     */
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1HospitalsHospitalIdQuestionsQuestionIdGet(hospitalId: UUID, questionId: UUID, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<QuestionViewModel, Error> {
        return Future<QuestionViewModel, Error>.init { promise in
    ...
    open class func apiV1HospitalsHospitalIdQuestionsQuestionIdGetWithRequestBuilder(hospitalId: UUID, questionId: UUID) -> RequestBuilder<QuestionViewModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<QuestionViewModel>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1HospitalsHospitalIdQuestionsQuestionIdPut(hospitalId: UUID, questionId: UUID, updateQuestionCommand: UpdateQuestionCommand? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<Bool, Error> {
        return Future<Bool, Error>.init { promise in
    ...
    open class func apiV1HospitalsHospitalIdQuestionsQuestionIdPutWithRequestBuilder(hospitalId: UUID, questionId: UUID, updateQuestionCommand: UpdateQuestionCommand? = nil) -> RequestBuilder<Bool> {
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{questionId}", with: questionIdPostEscape, options: .literal, range: nil)
        let localVariableURLString = CloudHospitalClient.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: updateQuestionCommand)
    ...
    open class func apiV1HospitalsQuestionsGetWithRequestBuilder(id: UUID? = nil, title: String? = nil, hospitalId: UUID? = nil, patientId: UUID? = nil, questionType: QuestionType? = nil, questionStatus: QuestionStatus? = nil, page: Int? = nil, limit: Int? = nil, lastRetrieved: Date? = nil, current: Bool? = nil) -> RequestBuilder<QuestionsViewModel> {
        let localVariablePath = "/api/v1/hospitals/questions"
        let localVariableURLString = CloudHospitalClient.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<QuestionsViewModel>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
