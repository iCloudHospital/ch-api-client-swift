...
open class ServicesCategoriesAPI {
    ...
    open class func apiV2ServicescategoriesGet(id: UUID? = nil, name: String? = nil, page: Int? = nil, limit: Int? = nil, lastRetrieved: Date? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<ServiceCategoriesModel, Error> {
    ...
    open class func apiV2ServicescategoriesGetWithRequestBuilder(id: UUID? = nil, name: String? = nil, page: Int? = nil, limit: Int? = nil, lastRetrieved: Date? = nil) -> RequestBuilder<ServiceCategoriesModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ServiceCategoriesModel>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV2ServicescategoriesServiceCategoryIdGet(serviceCategoryId: UUID, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<ServiceCategoryModel, Error> {
    ...
    open class func apiV2ServicescategoriesServiceCategoryIdGetWithRequestBuilder(serviceCategoryId: UUID) -> RequestBuilder<ServiceCategoryModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ServiceCategoryModel>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
