...
open class SpecialtyTypesAPI {
    ...
    open class func apiV1SpecialtytypesGetWithRequestBuilder(id: UUID? = nil, name: String? = nil, description: String? = nil, marketingType: MarketingType? = nil, created: Date? = nil, languageCode: String? = nil, ids: [UUID]? = nil, page: Int? = nil, limit: Int? = nil, lastRetrieved: Date? = nil, current: Bool? = nil) -> RequestBuilder<SpecialtyTypesViewModel> {
        let localVariablePath = "/api/v1/specialtytypes"
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1SpecialtytypesPost(specialtyTypeId: UUID? = nil, createSpecialtyTypeCommand: CreateSpecialtyTypeCommand? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<UUID, Error> {
    ...
    open class func apiV1SpecialtytypesPostWithRequestBuilder(specialtyTypeId: UUID? = nil, createSpecialtyTypeCommand: CreateSpecialtyTypeCommand? = nil) -> RequestBuilder<UUID> {
        let localVariablePath = "/api/v1/specialtytypes"
        let localVariableURLString = CloudHospitalClient.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: createSpecialtyTypeCommand)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1SpecialtytypesSlugsSlugGet(slug: String, languageCode: String? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<SpecialtyTypeViewModel, Error> {
    ...
    open class func apiV1SpecialtytypesSlugsSlugGetWithRequestBuilder(slug: String, languageCode: String? = nil) -> RequestBuilder<SpecialtyTypeViewModel> {
        var localVariablePath = "/api/v1/specialtytypes/slugs/{slug}"
        ...
        let localVariableRequestBuilder: RequestBuilder<SpecialtyTypeViewModel>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1SpecialtytypesSpecialtyTypeIdDelete(specialtyTypeId: UUID, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<Bool, Error> {
    ...
    open class func apiV1SpecialtytypesSpecialtyTypeIdDeleteWithRequestBuilder(specialtyTypeId: UUID) -> RequestBuilder<Bool> {
        var localVariablePath = "/api/v1/specialtytypes/{specialtyTypeId}"
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1SpecialtytypesSpecialtyTypeIdGet(specialtyTypeId: UUID, languageCode: String? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<SpecialtyTypeViewModel, Error> {
        return Future<SpecialtyTypeViewModel, Error>.init { promise in
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1SpecialtytypesSpecialtyTypeIdPut(specialtyTypeId: UUID, updateSpecialtyTypeCommand: UpdateSpecialtyTypeCommand? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<Bool, Error> {
        return Future<Bool, Error>.init { promise in
    ...
    open class func apiV1SpecialtytypesSpecialtyTypeIdPutWithRequestBuilder(specialtyTypeId: UUID, updateSpecialtyTypeCommand: UpdateSpecialtyTypeCommand? = nil) -> RequestBuilder<Bool> {
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{specialtyTypeId}", with: specialtyTypeIdPostEscape, options: .literal, range: nil)
        let localVariableURLString = CloudHospitalClient.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: updateSpecialtyTypeCommand)
