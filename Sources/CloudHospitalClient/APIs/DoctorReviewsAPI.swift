...
open class DoctorReviewsAPI {
    ...
    open class func apiV1DoctorsDoctorIdReviewsPatientIdDelete(doctorId: UUID, patientId: UUID, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<Bool, Error> {
    ...
    open class func apiV1DoctorsDoctorIdReviewsPatientIdDeleteWithRequestBuilder(doctorId: UUID, patientId: UUID) -> RequestBuilder<Bool> {
        var localVariablePath = "/api/v1/doctors/{doctorId}/reviews/{patientId}"
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1DoctorsDoctorIdReviewsPatientIdGet(doctorId: UUID, patientId: UUID, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<DoctorReviewViewModel, Error> {
    ...
    open class func apiV1DoctorsDoctorIdReviewsPatientIdGetWithRequestBuilder(doctorId: UUID, patientId: UUID) -> RequestBuilder<DoctorReviewViewModel> {
        ...
        let localVariableRequestBuilder: RequestBuilder<DoctorReviewViewModel>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1DoctorsDoctorIdReviewsPatientIdPut(doctorId: UUID, patientId: UUID, updateDoctorReviewCommand: UpdateDoctorReviewCommand? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<Bool, Error> {
        return Future<Bool, Error>.init { promise in
    ...
    open class func apiV1DoctorsDoctorIdReviewsPatientIdPutWithRequestBuilder(doctorId: UUID, patientId: UUID, updateDoctorReviewCommand: UpdateDoctorReviewCommand? = nil) -> RequestBuilder<Bool> {
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{patientId}", with: patientIdPostEscape, options: .literal, range: nil)
        let localVariableURLString = CloudHospitalClient.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: updateDoctorReviewCommand)
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func apiV1DoctorsDoctorIdReviewsPost(doctorId: UUID, patientId: UUID, createDoctorReviewCommand: CreateDoctorReviewCommand? = nil, apiResponseQueue: DispatchQueue = CloudHospitalClient.apiResponseQueue) -> AnyPublisher<DoctorReview, Error> {
    ...
    open class func apiV1DoctorsDoctorIdReviewsPostWithRequestBuilder(doctorId: UUID, patientId: UUID, createDoctorReviewCommand: CreateDoctorReviewCommand? = nil) -> RequestBuilder<DoctorReview> {
        var localVariablePath = "/api/v1/doctors/{doctorId}/reviews"
        let doctorIdPreEscape = "\(APIHelper.mapValueToPathItem(doctorId))"
        let doctorIdPostEscape = doctorIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{doctorId}", with: doctorIdPostEscape, options: .literal, range: nil)
        let patientIdPreEscape = "\(APIHelper.mapValueToPathItem(patientId))"
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{patientId}", with: patientIdPostEscape, options: .literal, range: nil)
        let localVariableURLString = CloudHospitalClient.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: createDoctorReviewCommand)
        ...
        let localVariableRequestBuilder: RequestBuilder<DoctorReview>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
    ...
    open class func apiV1DoctorsReviewsGetWithRequestBuilder(doctorId: UUID? = nil, doctorName: String? = nil, patientId: UUID? = nil, patientName: String? = nil, body: String? = nil, recommended: Bool? = nil, reviewCategory: ReviewCategory? = nil, rate: Int? = nil, created: Date? = nil, page: Int? = nil, limit: Int? = nil, lastRetrieved: Date? = nil, current: Bool? = nil) -> RequestBuilder<DoctorReviewsViewModel> {
        let localVariablePath = "/api/v1/doctors/reviews"
        let localVariableURLString = CloudHospitalClient.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
        ...
        let localVariableRequestBuilder: RequestBuilder<DoctorReviewsViewModel>.Type = CloudHospitalClient.requestBuilderFactory.getBuilder()
