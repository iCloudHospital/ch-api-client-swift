...
public struct UpdateSpecialtyTypeCategoryCommand: Codable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(selectedSpecialtyTypes, forKey: .selectedSpecialtyTypes)
    }
}
